      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-8 px-6 py-12 md:flex-row md:items-center md:justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-[var(--text-secondary)]">{settings.tagline}</p>
          </div>
        </div>
        <div className="flex flex-wrap gap-6 text-sm text-[var(--text-secondary)]">
          <Link to="/shop" className="hover:text-[var(--accent-primary)] transition-colors">Shop</Link>
          <Link to="/contact" className="hover:text-[var(--accent-primary)] transition-colors">Contact</Link>
          <Link to="/admin" className="hover:text-[var(--accent-primary)] transition-colors">Admin</Link>
        </div>
        <SocialLinks />
      </div>
