...
const item =
  "flex h-12 w-12 items-center justify-center rounded-2xl border border-[var(--line)] bg-[var(--surface)] text-[var(--text)] transition hover:-translate-y-0.5 hover:border-[var(--accent-primary)] hover:text-[var(--accent-primary)]";
...
export function SocialLinks({
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <a
        className={`${item} ${wrap} !bg-[var(--accent-secondary)] !text-white hover:!text-white`}
