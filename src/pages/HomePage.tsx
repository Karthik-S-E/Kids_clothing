    ...
    <div className="flex flex-col min-h-screen">
          ...
          <ScrollReveal delay={0.1} duration={0.9} direction="up">
            <div className="max-w-3xl">
              ...
              <p className="mt-6 max-w-xl text-lg sm:text-xl font-light leading-relaxed text-white/90">
                Traditional kurtas, lehengas, and festive sets made for kids. Lined with soft cotton so they stay comfy all day.
              </p>
              ...
              <div className="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-6 border-t border-white/15 pt-8">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs font-bold tracking-wider text-white">Express dispatch</p>
                    <p className="text-xs text-white/80">Pan-India Secure Delivery</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs font-bold tracking-wider text-white">Direct WhatsApp</p>
                    <p className="text-xs text-white/80">Instant order & customization</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <ScrollReveal delay={0.2} duration={0.8}>
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mt-6 text-lg sm:text-xl text-[var(--text-secondary)] font-light leading-relaxed">
              Kids’ festive clothes should feel gentle on the skin. We make every piece with light, soft cotton and silk so children can run, play, and celebrate in comfort.
            </p>
      ...
      <section className="py-24 px-6 lg:px-12 bg-[var(--surface)] border-y border-[var(--border)]">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            <div>
              <p className="text-xs font-semibold tracking-[0.3em] text-[var(--accent-primary)] mb-2">Curated masterpieces</p>
      ...
      <section className="py-20 px-6 lg:px-12 bg-[#0d1210] relative isolate">
        <div className="relative z-10 mx-auto max-w-5xl text-center">
          <div className="inline-flex items-center gap-2 rounded-full bg-[#052e16] border border-[#22c55e]/40 px-4 py-1.5 text-xs font-bold tracking-[0.2em] text-[var(--accent-primary)] mb-6">
            <MessageCircle className="h-4 w-4 text-[var(--accent-primary)]" />
            Direct WhatsApp concierge
          </div>
          <h2 className="font-display text-4xl sm:text-5xl font-normal text-white">
            Prefer ordering directly via <span className="text-[var(--accent-primary)] italic">WhatsApp</span>?
          </h2>

          <p className="mt-6 text-lg text-white/80 max-w-2xl mx-auto font-light leading-relaxed">
            Send us a photo of the piece you like or ask about sizes. We reply in just a few minutes!
          </p>
      ...
      <section className="py-24 px-6 lg:px-12 bg-[var(--background)]">
        <div className="mx-auto max-w-7xl text-center">
          <p className="text-xs font-semibold tracking-[0.3em] text-[var(--accent-primary)] mb-3">Tailored by age</p>
            ...
            {["1-4 Years", "2-5 Years", "4-8 Years", "5-8 Years"].map((age) => (
              ...
              >
                ...
                <div className="relative z-10 text-left bg-[#121212]/90 p-4 rounded-xl border border-white/10">
                  <span className="text-xs font-semibold tracking-[0.3em] text-[var(--accent-primary)] block mb-1">Collection</span>
