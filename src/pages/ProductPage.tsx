...
export function ProductPage() {
  ...
  // Verification & Order Flow States (matching CartModal)
  ...
  const handleWhatsAppOrderClick = async (e: React.MouseEvent<HTMLButtonElement>) => {
    e.preventDefault();
    setVerificationError(null);
    ...
    if (!user.emailVerified) {
      setVerificationError("Please verify your email before ordering via WhatsApp. Click 'Resend Verification Link' if needed.");
      return;
    }
    ...
    // Open confirmation popup identical to Cart checkout flow
    setTimeout(() => {
  ...
  return (
    <>
      <main className="mx-auto max-w-7xl px-4 py-6 font-sans text-stone-900 pt-20">
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-12 items-start">
          ...
          <section aria-label="Product Purchasing Options" className="lg:col-span-6 flex flex-col gap-6 bg-white/95 backdrop-blur-md rounded-2xl p-6 sm:p-8 border border-stone-200 shadow-sm lg:sticky lg:top-24">
            ...
            {/* Email Verification Warnings for WhatsApp Direct Order */}
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 text-amber-800">
                      Please verify <span className="underline font-medium">{currentUser.email}</span> to order via WhatsApp.
                    </p>
                    <button
                      type="button"
      ...
      {/* Confirmation Modal & Invoice Modal */}
